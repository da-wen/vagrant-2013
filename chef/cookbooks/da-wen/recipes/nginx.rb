...
cookbook_file "/var/www/default/index.php" do
  source "var/www/default/index.php"
  owner "vagrant"
  group "vagrant"
  mode 0777
end

cookbook_file "/var/www/default/phpinfo.php" do
  source "var/www/default/phpinfo.php"
  owner "vagrant"
  group "vagrant"
  mode 0777
end
